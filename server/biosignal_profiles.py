...
PROFILE_REGISTRY: Dict[str, BiosignalProfile] = {
    ...
    "eda": BiosignalProfile(
        ...
        robotic_arm_supported=False,
        support_level="trainable_profile",
        support_notes="Cyton live streaming is available when an EDA/GSR-compatible sensor is wired into the analog inputs; synthetic streaming, live tonic/phasic state decoding, and supervised training are also available.",
